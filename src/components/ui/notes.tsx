...
export function Morphe() {
  ...
  return (
    ...
    >
      <MorphingPopoverTrigger className="flex h-9 items-center rounded-xl shadow-none border-0 bg-sky-500/10 px-3 text-sky-700 dark:border-zinc-50/10 dark:bg-zinc-700 dark:text-zinc-50">
